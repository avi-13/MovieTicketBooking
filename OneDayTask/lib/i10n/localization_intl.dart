...
class IntlLocalizations {
  ...
  String get appName{
    return Intl.message("One Day List",name: "appName",desc: "appDescription");
  }
  String get tryToSearch => Intl.message('Try searching for the title or content', name: 'tryToSearch', desc: 'Search',);
  String get searchIcon => Intl.message('Try searching for icon name', name: 'searchIcon', desc: 'Search',);


  String get myAccount => Intl.message('My Account', name: 'myAccount', desc: 'myAccount',);
  ...
  String get feedbackWall => Intl.message('Feedback Wall', name: 'feedbackWall', desc: 'feedbackWall',);
  String get feedbackCantBeNull => Intl.message('feedback cannot be empty', name: 'feedbackCantBeNull', desc: 'feedbackCantBeNull',);
  String get feedbackIsTooLittle => Intl.message('feedback is too little, add a little more', name: 'feedbackIsTooLittle', desc: 'feedbackIsTooLittle',);
  String get feedbackNeedEmoji => Intl.message('please choose an emoji ', name: 'feedbackNeedEmoji', desc: 'feedbackNeedEmoji',);
  String get feedbackFrequently => Intl.message('Can only be submitted once in 8 hours. ', name: 'feedbackFrequently', desc: 'feedbackFrequently',);
  String get writeYourFeedback => Intl.message('write your feedback ', name: 'writeYourFeedback', desc: 'writeYourFeedback',);
  String get writeYourContactInfo => Intl.message('whether to leave your contact information', name: 'writeYourContactInfo', desc: 'writeYourContactInfo',);
  String get waitAMoment => Intl.message('please wait for a moment...', name: 'waitAMoment', desc: 'waitAMoment...',);
  String get submitSuccess => Intl.message('submit success!', name: 'submitSuccess', desc: 'submitSuccess！',);
  String get thanksForFeedback => Intl.message('Thanks for your feedback', name: 'thanksForFeedback', desc: 'thanksForFeedback',);
  String get submitAgain => Intl.message('submit again', name: 'submitAgain', desc: 'submitAgain',);
  String get noName => Intl.message('anonymous', name: 'noName', desc: 'noName',);
